...
class InputAutocompleteComponentProxy extends InputAutocompleteComponent {
  ...
  */
  ...
  autogenerated_html.EventListener __listener__e8_blur_4;
  
  autogenerated_html.EventListener __listener__e8_focus_5;
  
  autogenerated_html.EventListener __listener__e8_keyUp_6;
  ...
  void inserted_autogenerated() {
      ...
      if (_isVisible__e7 && !showNow) {
        ...
        __stoppers2_1.add(autogenerated.watchAndInvoke(() => matches, (_) {
          ...
          for (var choice in matches) {
            ...
            var __binding2;
            __e4 = new autogenerated_html.Element.html('<li>\n                  <div id="__e-3"></div>\n                  <!--content select=".choiceTemplate"></content-->\n                </li>');
            ...
            __stoppers3_2_1.add(autogenerated.watchAndInvoke(() =>  choice.key , (__e) { __e4.attributes['choice-key'] = __e.newValue; }));
            __stoppers3_2_1.add(autogenerated.watchAndInvoke(() => '${ renderChoice(choice) }', (__e) {
    ...
    __listener__e8_blur_4 = ($event) {
      inputBlur($event);
      autogenerated.dispatch();
    };
    __e8.on.blur.add(__listener__e8_blur_4);
    
    __listener__e8_focus_5 = ($event) {
      inputFocus($event);
      autogenerated.dispatch();
    };
    __e8.on.focus.add(__listener__e8_focus_5);
    
    __listener__e8_keyUp_6 = ($event) {
      keyPressed($event);
      autogenerated.dispatch();
    };
    __e8.on.keyUp.add(__listener__e8_keyUp_6);
  ...
  void removed_autogenerated() {
    ...
    __e8.on.blur.remove(__listener__e8_blur_4);
    __listener__e8_blur_4 = null;
    
    __e8.on.focus.remove(__listener__e8_focus_5);
    __listener__e8_focus_5 = null;
    
    __e8.on.keyUp.remove(__listener__e8_keyUp_6);
    __listener__e8_keyUp_6 = null;
